...
export async function buildFeeDistributorMessage(txHash, sender, value) {
    ...
    return `
💰${hyperlink(feeCollectorUrl, 'Fee Collector')} received ${formatForPrint(value)} crvUSD from${hyperlink(senderUrl, senderTag)}
Links:${hyperlink(txHashUrl, 'txHash')} 🦙🦙🦙
  `;
}
export function buildFeeDistributorSummaryMessage(totalCrvUSD) {
    const feeCollectorAddress = '0xa2Bcd1a4Efbd04B63cd03f5aFf2561106ebCCE00';
...
export async function buildCrvUSDFlashloanMessage(event) {
